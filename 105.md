...
```typescript
  ...
  interface ReviewContent = {
    service_provider_pubkey: string,          // Pubkey of the service provider you used
    zap_receipt_json: string, //Stringified JSON of the zap receipt the service provider provided you with
  }
```
